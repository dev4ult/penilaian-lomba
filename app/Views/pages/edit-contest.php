...
<form method="post" action="/contest/put"
    ...
    <div class="flex flex-col gap-1 w-full">
        ...
        <input type="text" id="contest-name" name="contest-name" class="input input-bordered"
            placeholder="Isikan Nama Lomba" value="<?= $contest['contest_name'] ?>" required>
    </div>
    ...
    <div class="flex flex-col gap-1 w-full">
        ...
        <input type="text" id="organizer" name="organizer" class="input input-bordered"
            placeholder="Isikan Nama Penyelenggara" value="<?= $contest['organizer'] ?>" required>
    </div>
    ...
    <div class="flex flex-col gap-1 w-full col-span-2">
        ...
        <textarea type="text" id="description" name="description" class="textarea textarea-bordered text-base h-52 py-3"
            placeholder="Isikan Deskripsi Lomba" required><?= $contest['description'] ?></textarea>
    </div>
    ...
    <div class="flex flex-col gap-1 w-full">
        ...
        <div class="join">
            <input type="time" id="time-start" name="time-start" class="input input-bordered join-item w-full"
                value="<?= $contest['time_start'] ?>" required />
            <input type="time" id="time-end" name="time-end" class="input input-bordered join-item w-full"
                value="<?= $contest['time_end'] ?>" required />
        </div>
    </div>
    ...
    <div class="flex flex-col gap-1 w-full">
        ...
        <input type="text" id="held-on" name="held-on" class="input input-bordered"
            placeholder="Isikan Nama Tempat Lomba" value="<?= $contest['held_on'] ?>" required>
    </div>
