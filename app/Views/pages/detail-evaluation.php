...
<header class="pb-10 border-b-2 flex justify-between gap-3">
    <div class="prose ">
        ...
        <p>Kategori Penilaian memberikan akses untuk merubah dan mengetahui secara detail mengenai penilaian apa saja
            yang dilakukan terhadap peserta lomba.</p>
    </div>
...
<dialog id="add_modal" class="modal">
    <form id="form-add-category" action="/contest/evaluation-aspect/add" method="post" class="modal-box p-8 relative">
        ...
        <p class="mb-6">Form Tambah Kategori memberikan akses untuk menambah kategori penilaian.</p>
