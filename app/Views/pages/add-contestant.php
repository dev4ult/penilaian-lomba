...
<!-- Form -->
<form method="post" action="/contestant/add" class="p-8 bg-white my-10 border-2 rounded-lg grid grid-flow-row grid-cols-2 gap-6">
    ...
    <div class="flex flex-col gap-1 w-full">
        ...
        <input type="text" id="leader" name="leader" class="input input-bordered" placeholder="Isikan Nama Penanggung Jawab" required>
    </div>
    ...
    <div class="col-span-2 grid grid-flow-row grid-cols-2 gap-6">
        ...
        <div class="flex flex-col gap-1 w-full">
            ...
            <input type="text" id="member-name-1" name="member-name-1" class="input input-bordered" placeholder="Isikan Nama Lengkap" required>
        </div>
