...
<!-- Form -->
<form method="post" action="/contestant/put"
    class="p-8 bg-white my-10 border-2 rounded-lg grid grid-flow-row grid-cols-2 gap-6">

    <input type="number" class="hidden" id="contestant-id" name="contestant-id"
        value="<?= $contestant['contestant_id'] ?>" />

    <!-- Team Name -->
    <div class="flex flex-col gap-1 w-full">
        <label for="team" class="text-sm font-semibold">Nama Tim</label>
        <input type="text" id="team" name="team" class="input input-bordered" placeholder="Isikan Nama Tim"
            value="<?= $contestant['team_name'] ?>" required />
    </div>
    ...
    <div class="flex flex-col gap-1 w-full">
        ...
        <input type="text" id="leader" name="leader" class="input input-bordered"
            placeholder="Isikan Nama Penanggung Jawab" value="<?= $contestant['leader'] ?>" required />
    </div>
    ...
    <div class="flex flex-col gap-1 w-full">
        ...
        <input type="text" id="school" name="school" class="input input-bordered"
            placeholder="Isikan Nama Instasi / Sekolah" value="<?= $contestant['school'] ?>" required />
    </div>
    ...
    <div class="flex flex-col gap-1 w-full">
        ...
        <input type="number" id="phone-number" name="phone-number" class="input input-bordered"
            placeholder="Isikan Nomor Telepon" value="<?= $contestant['phone_number'] ?>" required />
    </div>
    ...
    <div class="col-span-2 grid grid-flow-row grid-cols-2 gap-6">
        ...
        <div class="flex flex-col gap-1 w-full">
            ...
            <input type="text" id="member-name-1" name="member-name-1" class="input input-bordered"
                placeholder="Isikan Nama Lengkap" value="<?= $members[0]['full_name'] ?>" required />
        </div>
        ...
        <div class="flex flex-col gap-1 w-full">
            ...
            <input type="number" id="nis-1" name="nis-1" class="input input-bordered"
                placeholder="Isikan Nomor Induk Siswa" value="<?= $members[0]['student_id'] ?>" required />
        </div>
    </div>
