...
<head>
    ...
    <title>KOPI</title>
    <link rel="icon" href="<?php echo base_url('./images/logo.png') ?>" type="image/gif">
...
<body class="font-inter bg-purple-50 min-h-screen flex overflow-x-hidden">
    <div class="bg-white border-r-2 ">
        <aside class="bg-white p-10 min-w-[20rem] h-screen sticky top-0">
